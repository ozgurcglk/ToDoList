# ToDoList
Basic implementation of a RESTful "to do list" application in accordance with SOLID, created in Java Spring Boot using H2  in memory database.
